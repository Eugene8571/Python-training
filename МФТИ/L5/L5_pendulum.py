...
vertical_center = gr.Point(0, vertical_top.y + (vertical_bot.y - vertical_top.y)/2)
...
while True:
	...
	acceleration=add(update_horisontal_acceleration(coords, nail_coords), \
        update_vertical_acceleration(coords, vertical_center))
	#acceleration=
